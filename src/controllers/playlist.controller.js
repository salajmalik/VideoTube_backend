...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if(playlist.videos.includes(videoId)){
            return res.status(200).json(new ApiResponse(200,{},"Video Is  already present In Playlist"))
        }
        ...
        return res.status(200).json(new ApiResponse(200,addedplaylist,"Video Successfully Added To Playlist"))
    } catch (error) {
...
const removeVideoFromPlaylist = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json(new ApiResponse(200,addedplaylist,"Video Successfully Removed From Playlist"))
